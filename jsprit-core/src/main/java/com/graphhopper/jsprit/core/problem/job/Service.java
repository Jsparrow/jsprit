...
public class Service extends AbstractJob {
    ...
    public String toString() {
        return new StringBuilder().append("[id=").append(id).append("][name=").append(name).append("][type=").append(type).append("][location=")
				.append(location).append("][capacity=").append(size).append("][serviceTime=").append(serviceTime).append("][timeWindows=").append(timeWindows)
				.append("]").toString();
    }
    ...
    public static class Builder<T extends Service> {
		...
		public Builder<T> addAllTimeWindows(Collection<TimeWindow> timeWindows) {
            timeWindows.forEach(tw -> addTimeWindow(tw));
            return this;
        }
        ...
        public T build() {
            if (location == null) {
				throw new IllegalArgumentException(new StringBuilder().append("The location of service ").append(id).append(" is missing.").toString());
			}
