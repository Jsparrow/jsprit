...
public class VehicleTypeImpl implements VehicleType {
    ...
    public String toString() {
        return new StringBuilder().append("[typeId=").append(typeId).append("]").append("[capacity=").append(capacityDimensions).append("]").append("[costs=")
				.append(vehicleCostParams).append("]").toString();
    }
    ...
    public static class VehicleCostParams {
		...
		@Override
        public String toString() {
            return new StringBuilder().append("[fixed=").append(fix).append("][perTime=").append(perTransportTimeUnit).append("][perDistance=").append(perDistanceUnit)
					.append("][perWaitingTimeUnit=").append(perWaitingTimeUnit).append("]").toString();
        }
    ...
    public static class Builder {
        ...
        public Builder addCapacityDimension(int dimIndex, int dimVal) {
            ...
            if (capacityDimensions != null) {
				throw new IllegalArgumentException(new StringBuilder().append("Either build your dimension with build your dimensions with ").append("addCapacityDimension(int dimIndex, int dimVal) or set the already built dimensions with .setCapacityDimensions(Capacity capacity).").append("You used both methods.").toString());
			}
            dimensionAdded = true;
